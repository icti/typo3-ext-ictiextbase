 ...
 */
class Tx_Ictiextbase_ViewHelpers_Page_Content_GetViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
    ...
    $this->registerArgument('tvField', 'string', 'TemplaVoila: Name of the flexform field to render', FALSE, '');
    ...
    $tvField = $this->arguments['tvField'];
