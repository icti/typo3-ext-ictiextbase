 ...
 * @api
 */
class Tx_Ictiextbase_ViewHelpers_Widget_PaginateViewHelper extends Tx_Fluid_ViewHelpers_Widget_PaginateViewHelper {

	/**
	 * @var Tx_Ictiextbase_ViewHelpers_Widget_Controller_PaginateController
	 */
	protected $controller;

	/**
	 * @param Tx_Ictiextbase_ViewHelpers_Widget_Controller_PaginateController $controller
	 * @return void
	 */
	public function injectController(Tx_Ictiextbase_ViewHelpers_Widget_Controller_PaginateController $controller) {
